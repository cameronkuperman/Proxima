    ...
    <section id="contact" className="relative py-16 px-6 overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-20">
          <a href="mailto:help@seimeo.com" className="flex items-center gap-3 text-gray-400 hover:text-white transition-colors">
        ...
        <div className="pt-20 border-t border-gray-800">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <Link href="/security" className="text-gray-500 hover:text-gray-300 transition-colors">Security</Link>
            </div>
          </div>
