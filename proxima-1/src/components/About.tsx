    ...
    <section id="about" className="relative py-16 px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16">
          <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition-all duration-300">
        ...
        {/* Team Note */}
        <div className="mt-20 p-8 bg-gray-900/30 border border-gray-800 rounded-2xl">
